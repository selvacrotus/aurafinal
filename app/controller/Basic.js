Ext.define("CrotusValet.controller.Basic",{
    ...
    config:{
        ...
        control:{
            ...
            galleryView: {
                informationCommand: "oninformationCommandd",
...
/*
    ...
    onSearchKeyUp: function(field) {
        ...
        var value = field.getValue(),
            store = this.getProductMastersStore();
        ...
        handler: function () {
            ...
            if(settingslocalStore.getData().length==0) {
                ...
                settingslocalStore.each(function (record) {
                    ...
                    console.log(record.data.ResName);
                    console.log(record.data.ResId);
                    //sendmail
                    ...
                    loginStore.setProxy({
                      ...
                      url: 'http://1.23.183.6:8085/CrotusValetHandler.ashx?requestname=' + requestname + '&requestcontent=' + paneltext + '&resId=' + record.data.ResId + '&resname=' + record.data.ResName
                      ...
                      //      var paneltime = nestedList.down('#txtTimeId').getValue();
                            ...
                            settingslocalStore.each(function (record) {
                                ...
                                //    url: ' http://localhost/CrotusValetService/CrotusValetHandler.ashx?requestname=' + requestname + '&requestcontent=' + panelrequest + '&resId=' + record.data.ResId + '&resname=' + record.data.ResName
                                   url: 'http://1.23.183.6:8085/CrotusValetHandler.ashx?requestname=' + requestname + '&requestcontent=' + panelrequest + '&resId=' + record.data.ResId + '&resname=' + record.data.ResName
    ...
    onbackToRequirement: function ()
{
    ...
    oninformationCommandd: function () {
